...
public class TicketDAO {
	...
	public boolean checkRegNumber(String regNumberPlate) {
		Connection con = null;
		try {
			con = dataBaseConfig.getConnection();
			PreparedStatement ps = con.prepareStatement(DBConstants.GET_COUNT_REG_NUMBER);

			ps.setString(1, regNumberPlate);
			ResultSet rs = ps.executeQuery();
